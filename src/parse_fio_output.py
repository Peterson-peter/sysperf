...
def parse_output(output: list) -> dict:
    ...
    for iterations in output:
        read_iops += iterations["jobs"][0]['read']['iops']
        read_iops_min += iterations['jobs'][0]['read']['iops_min']
        read_iops_max += iterations['jobs'][0]['read']['iops_max']
        read_clat_ns_min += iterations['jobs'][0]['read']['clat_ns']['min']
        read_clat_ns_max += iterations['jobs'][0]['read']['clat_ns']['max']
        read_clat_ns_mean += iterations['jobs'][0]['read']['clat_ns']['mean']
        read_slat_ns_min += iterations['jobs'][0]['read']['slat_ns']['min']
        read_slat_ns_max += iterations['jobs'][0]['read']['slat_ns']['max']
        read_slat_ns_mean += iterations['jobs'][0]['read']['slat_ns']['mean']
        read_lat_ns_min += iterations['jobs'][0]['read']['lat_ns']['min'] 
        read_lat_ns_max += iterations['jobs'][0]['read']['lat_ns']['max']
        read_lat_ns_mean += iterations['jobs'][0]['read']['lat_ns']['mean']
        write_iops += iterations["jobs"][0]['write']['iops']
        write_iops_min += iterations['jobs'][0]['write']['iops_min']
        write_iops_max += iterations['jobs'][0]['write']['iops_max']
        write_clat_ns_min += iterations['jobs'][0]['write']['clat_ns']['min']
        write_clat_ns_max += iterations['jobs'][0]['write']['clat_ns']['max']
        write_clat_ns_mean += iterations['jobs'][0]['write']['clat_ns']['mean']
        write_slat_ns_min += iterations['jobs'][0]['write']['slat_ns']['min']
        write_slat_ns_max += iterations['jobs'][0]['write']['slat_ns']['max']
        write_slat_ns_mean += iterations['jobs'][0]['write']['slat_ns']['mean']
        write_lat_ns_min += iterations['jobs'][0]['write']['lat_ns']['min'] 
        write_lat_ns_max += iterations['jobs'][0]['write']['lat_ns']['max']
        write_lat_ns_mean += iterations['jobs'][0]['write']['lat_ns']['mean']
